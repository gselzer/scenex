...
`scenex` can be used in a variety of contexts. It supports various **GUI
 frameworks**, including [PyQt](https://riverbankcomputing.com/software/pyqt), [wxPython](https://wxpython.org),
...
These frameworks are *not* included directly with `scenex` and must be installed
